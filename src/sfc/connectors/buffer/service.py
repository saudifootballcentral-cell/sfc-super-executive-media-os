"""Buffer API connector service — all calls mocked, credentials from env."""
...
class BufferService:
    """Buffer API connector. Buffer routes to Instagram, Threads, Facebook,
    TikTok. All calls mocked; inject BUFFER_ACCESS_TOKEN env var for real use."""
    ...
    def _platforms_for_package_type(self, pkg_type: str) -> list[BufferPlatform]:
        mapping: dict[str, list[BufferPlatform]] = {
            ...
            "youtube_short": [BufferPlatform.INSTAGRAM, BufferPlatform.FACEBOOK],
            "x_thread": [],
